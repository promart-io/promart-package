...
var dao = require('promart-solution-composer/data/dao/Solutions/Solutions');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Solutions not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-solution-composer/api/Solutions.js/' + entity.Id);
