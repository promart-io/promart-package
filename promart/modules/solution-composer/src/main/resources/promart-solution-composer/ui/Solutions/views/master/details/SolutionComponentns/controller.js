...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'promart.Solutions.SolutionComponentns.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('promart.Solutions.SolutionComponentns.refresh', callback);
		},
		onSolutionsSelected: function(callback) {
			on('promart.Solutions.Solutions.selected', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/promart-solution-composer/api/Solutions/SolutionComponentns.js';
