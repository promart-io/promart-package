...
var dao = require('promart-payments/data/dao/Finances/PurchaseOrders');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('PurchaseOrders not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-payments/api/PurchaseOrders.js/' + entity.Id);
