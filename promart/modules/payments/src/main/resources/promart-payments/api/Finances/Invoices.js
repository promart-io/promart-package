...
var dao = require('promart-payments/data/dao/Finances/Invoices');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-payments/api/Invoices.js/' + entity.Id);
