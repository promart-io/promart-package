...
var dao = require('promart-payments/data/dao/Finances/PurchaseOrderStatuses');
var http = require('promart-payments/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('PurchaseOrderStatuses not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-payments/api/PurchaseOrderStatuses.js/' + entity.Id);
