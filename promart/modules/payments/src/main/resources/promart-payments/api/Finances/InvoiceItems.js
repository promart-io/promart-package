...
var dao = require('promart-payments/data/dao/Finances/InvoiceItems');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('InvoiceItems not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-payments/api/InvoiceItems.js/' + entity.Id);
