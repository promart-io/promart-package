...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'promart.promart-payments.Products.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('promart.promart-payments.Products.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/promart-payments/api/Products.js';
