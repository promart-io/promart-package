...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'promart.promart-payments.InvoiceItems.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('promart.promart-payments.InvoiceItems.refresh', callback);
		},
		onInvoicesSelected: function(callback) {
			on('promart.promart-payments.Invoices.selected', callback);
		},
