...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'promart.Marketplace.Plans.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('promart.Marketplace.Plans.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/promart-marketplace/api/Marketplace/Plans.js';
	var typeOptionsApi = '/services/v3/js/promart-marketplace/api/Marketplace/PlanTypes.js';
	var supportlevelOptionsApi = '/services/v3/js/promart-marketplace/api/Marketplace/SupportLevels.js';
	var salesmodelOptionsApi = '/services/v3/js/promart-marketplace/api/Marketplace/SalesModels.js';
