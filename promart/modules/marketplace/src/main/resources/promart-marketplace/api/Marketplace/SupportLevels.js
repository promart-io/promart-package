...
var dao = require('promart-marketplace/data/dao/Marketplace/SupportLevels');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-marketplace/api/SupportLevels.js/' + entity.Id);
