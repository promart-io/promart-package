...
var dao = require('promart-marketplace/data/dao/Marketplace/PlanTypes');
var http = require('promart-marketplace/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('PlanTypes not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-marketplace/api/PlanTypes.js/' + entity.Id);
