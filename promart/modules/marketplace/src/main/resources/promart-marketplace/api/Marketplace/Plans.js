...
var dao = require('promart-marketplace/data/dao/Marketplace/Plans');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Plans not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-marketplace/api/Plans.js/' + entity.Id);
