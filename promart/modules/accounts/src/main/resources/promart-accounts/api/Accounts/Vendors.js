...
var dao = require('promart-accounts/data/dao/Accounts/Vendors');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Vendors not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-accounts/api/Vendors.js/' + entity.Id);
