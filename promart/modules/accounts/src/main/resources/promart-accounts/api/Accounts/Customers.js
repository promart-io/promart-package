...
var dao = require('promart-accounts/data/dao/Accounts/Customers');
...
rs.service()
	...
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-accounts/api/Customers.js/' + entity.Id);
