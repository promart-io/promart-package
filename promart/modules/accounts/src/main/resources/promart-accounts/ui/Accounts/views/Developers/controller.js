...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'promart.Accounts.Developers.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('promart.Accounts.Developers.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '/services/v3/js/promart-accounts/api/Accounts/Developers.js';
