...
var dao = require('promart-component-registry/data/dao/Components/Components');
var http = require('promart-component-registry/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Components not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/promart-component-registry/api/Components.js/' + entity.Id);
